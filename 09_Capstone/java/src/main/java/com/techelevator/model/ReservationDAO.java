...
public interface ReservationDAO {
	...
	// Insert a new reservation into the reservation table and return the new reservation ID.
	public int makeReservation(int siteId, LocalDate from, LocalDate to, String resName);
	// Check if a site is available during the desired time. Return true if available
	// false if not.
